...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(diabetes_loader_train):
        ...
        netD.zero_grad()
        d_gan_labels_real = d_gan_labels_real.resize_as_(diabetes_labels.data.cpu().uniform_(0, 0.3))
        ...
        d_gan_labels_fake = d_gan_labels_fake.resize_as_(diabetes_labels.data.cpu().uniform_(0.9, 1.2))
