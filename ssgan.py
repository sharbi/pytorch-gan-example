...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(svhn_loader_train):
        ...
        netD.zero_grad()
        d_gan_labels_real = torch.FloatTensor(svhn_labels.data.shape[0], 1, 1).uniform_(0.9, 1.2)
        ...
        d_gan_labels_fake = torch.FloatTensor(svhn_labels.data.shape[0], 1, 1).uniform_(0.9, 1.2)
