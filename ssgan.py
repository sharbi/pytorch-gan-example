...
for epoch in range(num_epochs):
    ...
    for i, data in enumerate(diabetes_loader_train):
        ...
        d_gan_labels_real = d_gan_labels_real.resize_as_(gan_logits_real.data.cpu()).uniform_(0.9, 1.2)
        ...
        d_gan_labels_fake = d_gan_labels_fake.resize_as_(diabetes_labels.data.shape[0]).fill_(0)
